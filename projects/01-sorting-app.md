...
In the following steps, we will only display the Unix/Linux commands which you can do in GitHub Codespace. If you want to work locally, see the [appendix](#appendix-setup-for-local-machine).
...
You can choose to do the mini project on your local machine first before submitting to eDimension. 
